...
export default function TeamSection({ team, onDuplicate, onDelete, onUpdateName, onUpdateTeam, onTogglePin, isReadOnly = false }: TeamSectionProps) {
  ...
  if (isFullscreen) {
    return (
      <div className="fixed inset-0 z-50 bg-black/50 overflow-hidden flex flex-col">
        <div className="bg-[rgb(var(--bg-primary))] h-full overflow-y-auto">
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 w-full pb-8">
              ...
              {/* Marcador de fin de contenido - detiene el scroll aquí */}
